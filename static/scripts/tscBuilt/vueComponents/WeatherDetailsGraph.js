...
app.component('weather-details-graph', {
    ...
    methods: {
        ...
        drawGraphs() {
            ...
            const tempCharCanvas = document.getElementById("temperatureChart");
            ...
            const tempChart = new Chart(tempCharCanvas, tempGraphConfig);
            this.tChartHandle = tempChart;
            //console.log("tempchart handle:");
            //this.tChartHandle = tempChart;
            //console.log(this.tChartHandle);
            //tempChart.destroy();
            const humCharCanvas = document.getElementById("humidityChart");
            ...
            const humChart = new Chart(humCharCanvas, humGraphConfig);
