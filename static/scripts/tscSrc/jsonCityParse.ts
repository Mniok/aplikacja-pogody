...
//   <!-- <script type="application/javascript" type="module" src="{% static '/scripts/tscBuilt/jsonCityParse.js' %}"></script> -->
//   <!-- the JSON is too big and node process swells to many megabytes when importing -->
...
//require('./city_list_lite_for_tests.json');
        ...
        //import citiesJSON from './city_list.json' assert {type: 'json'};
